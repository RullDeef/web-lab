...
export class coreInit1665615724636 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "study_groups" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "tutor_id" integer, CONSTRAINT "PK_d3c236286b727d74553c7a88dc3" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "texts" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "content" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "creator_id" integer, CONSTRAINT "PK_ce044efbc0a1872f20feca7e19f" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`ALTER TABLE "study_groups" ADD CONSTRAINT "FK_e3ac0a4eb7d61c4e82115fa86e7" FOREIGN KEY ("tutor_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "texts" ADD CONSTRAINT "FK_7b54bc8fe8fc2319b30ae3ce90e" FOREIGN KEY ("creator_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "study_groups_users" ADD CONSTRAINT "FK_a61bf7c64f54dd642599528ff37" FOREIGN KEY ("group_id") REFERENCES "study_groups"("id") ON DELETE SET NULL ON UPDATE CASCADE`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "texts" DROP CONSTRAINT "FK_7b54bc8fe8fc2319b30ae3ce90e"`);
