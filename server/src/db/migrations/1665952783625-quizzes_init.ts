...
export class quizzesInit1665952783625 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "quizzes" ADD CONSTRAINT "FK_415fa0f36f70c345fc59ec9474e" FOREIGN KEY ("creator_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    await queryRunner.query(`ALTER TABLE "quiz_results" ADD CONSTRAINT "FK_28848f36ed7c878f3d8dd754375" FOREIGN KEY ("student_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "quiz_answers" ADD CONSTRAINT "FK_642006690f441472f3d7b6b3059" FOREIGN KEY ("quiz_result_id") REFERENCES "quiz_results"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "quiz_answers" ADD CONSTRAINT "FK_9891b14a7212c6271f40f70a786" FOREIGN KEY ("option_id") REFERENCES "quiz_options"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
